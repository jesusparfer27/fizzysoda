...
import { Content, asText } from "@prismicio/client"; // <-- Importa asText aquí
...
const Hero: FC<HeroProps> = ({ slice }) => {
  ...
  return (
    ...
    className="heron opacity-0">
      <div className="grid">
        <div className="grid h-screen place-items-center">
          <div className="grid auto-rows-min place-items-center text-center">
            <h1 className="hero-header lg:text-[13] text-7xl font-black uppercase
             leading-[.8] text-orange-500 md:text-[9rem] lg:text-[13rem]">
